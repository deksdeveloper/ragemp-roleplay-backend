...
class animationCommands : Script
{
    ...
    public static void handsUp(Player Client)
    {
        ...
        {
            Main.SendErrorMessage(Client, "Kelepçeliyken bu işlemi yapamazsın.");
            return;
        }
    ...
    public static void KeyPress0(Player Client)
    {
        ...
        {
            Main.SendErrorMessage(Client, "Bu animasyonu durduramazsınız!");
            return;
        }
    ...
    [Command("anim", Alias = "animasyon, animasyonlar, animler")]
    public void helpAnimmation(Player Client)
    {
        Main.SendCustomChatMessasge(Client, "~c~----------------------------------------------------------------------------------");
        Main.SendCustomChatMessasge(Client, "~c~ANIMASYON:~w~ /surrender - /facepalm - /loco - /drink - /eat - /kiss - /dj - /crouch ");
        Main.SendCustomChatMessasge(Client, "~c~ANIMASYON:~w~ /stumble - /injured - /rock - /handsheat - /pensive - /desperate - /shrug ");
        Main.SendCustomChatMessasge(Client, "~c~ANIMASYON:~w~ /piss - /dance - /cheer - /lean - /phone - /idle - /dead - /guard - /sports ");
        Main.SendCustomChatMessasge(Client, "~c~ANIMASYON:~w~ /smoke - /knuckles - /walk - /victory - /arms - /liedown - /thump - /kneel");
        Main.SendCustomChatMessasge(Client, "~c~ANIMASYON:~w~ /sit - /sexydance - /carsex - /cpr - /plant - /puke - /drunk - /aplause");
        Main.SendCustomChatMessasge(Client, "~c~ANIMASYON:~w~ /fucku - /aim  - /striptease - /tagging - /knockdoor - /type");
        Main.SendCustomChatMessasge(Client, "~c~ANIMASYON:~w~ /hurryup - /shower - /clean - /cry - /dig - /mechanic - /speak - /grab");
        Main.SendCustomChatMessasge(Client, "~c~----------------------------------------------------------------------------------");
    }
    ...
    public void GrabCommand(Player Client)
    {
        ...
        {
            Main.SendErrorMessage(Client,  Translation.message_17);
        }
        else
        {
            Client.StopAnimation();
    ...
    [Command("mechanic", "~y~[!]~w~: /mechanic [1-3]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 3:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: /mechanic [1-3]");
                    break;
            }
        }
    }
        ...
        else
        {
            switch (action)
            {
                ...
                case 5:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/clean [1-5]");
                    break;
            }
        }
    }

    [Command("shower", "~y~[!]~w~: /shower [1-2]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 2:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/shower [1-2]");
                    break;
            }
        }
    }
    ...
    [Command("sports", "~y~[!]~w~: /sports [1-15]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 15:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/sports [1-15]");
                    break;
            }
        }
    }
    ...
    [Command("striptease", "~y~[!]~w~: /striptease [1-14]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 14:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/striptease [1-14]");
                    break;
            }
        }
    }
    ...
    public void SaluteCommand(Player Client, int action)
    {
        ...
        else
        {
            ...
            switch (action)
            {
                ...
                default:
                    Client.StopAnimation();
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/salute [1-6]");
                    break;
            }
        }
    }
        ...
        else
        {
            switch (action)
            {
                ...
                case 21:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/walk [1-21]");
                    break;
            }
        }
    }
    ...
    [Command("surrender", "~y~[!]~w~: /surrender [1-11]")]
        ...
        else
        {
            ...
            switch (action)
            {
                ...
                case 11:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/surrender [1-11]");
                    break;
            }
        }
    }
        ...
        else
        {
            switch (action)
            {
                ...
                case 4:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/cpr [1-4]");
                    break;
            }
        }
    }

    [Command("carsex", "~y~[!]~w~: /carsex [1-6]")]
    public void CarSexCommand(Player Client, int action)
    {
        ...
        {
            Main.SendErrorMessage(Client,  "Bu komutu sadece araç içerisinde kullanabilirsiniz.");
        }
        else
        {
            ...
            switch (action)
            {
                ...
                case 3:
                    ...
                    {
                        Main.SendErrorMessage(Client,  "Ön yolcu koltuğunda olmalısınız.");
                    }
                    else
                    {
                        Client.StopAnimation();
                ...
                case 6:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/carsex [1-6]");
                    break;
            }
        }
    }

    [Command("sexydance", "~y~[!]~w~: /sexydance [1-6]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 6:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/sexydance [1-6]");
                    break;
            }
        }
    }

    [Command("sit", "~y~[!]~w~: /sit [1-11]")]
        ...
        else
        {
            ...
            switch (action)
            {
                ...
                case 11:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/sit [1-11]");
                    break;
            }
        }
    }

    [Command("smoke", "~y~[!]~w~: /smoke [1-3]")]
        ...
        else
        {
            ...
            switch (action)
            {
                ...
                case 3:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/smoke [1-3]");
                    break;
            }
        }
    }

    [Command("liedown", "~y~[!]~w~: /liedown [1-6]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 6:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/liedown [1-6]");
                    break;
            }
        }
    }

    [Command("arms", "~y~[!]~w~: /arms [1-4]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 4:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/arms [1-4]");
                    break;
            }
        }
    }

    [Command("guard", "~y~[!]~w~: /guard [1-4]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 4:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/guard [1-4]");
                    break;
            }
        }
    }

    [Command("dead", "~y~[!]~w~: /dead [1-5]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 5:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/dead [1-5]");
                    break;
            }
        }
    }

    [Command("idle", "~y~[!]~w~: /idle [1-9]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 9:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/idle [1-9]");
                    break;
            }
        }
    }

    [Command("phone", "~y~[!]~w~: /phone [1-5]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 5:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/phone [1-5]");
                    break;
            }
        }
    }

    [Command("lean", "~y~[!]~w~: /lean [1-11]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 12:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/lean [1-11]");
                    break;
            }
        }
    }

    [Command("cheer", "~y~[!]~w~: /cheer [1-7]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 7:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/cheer [1-7]");
                    break;
            }
        }
    }

    [Command("dance", "~y~[!]~w~: /dance [1-6]")]
        ...
        else
        {
            switch (action)
            {
                ...
                case 6:
                    ...
                    break;
                default:
                    Main.SendCustomChatMessasge(Client, "~y~[!]~w~: ~w~/dance [1-6]");
                    break;
            }
        }
    }
