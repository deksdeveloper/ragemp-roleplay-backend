...
public class WeaponManage : Script
{
    ...
    public static void SetPlayerWeaponEx(Player Client, string Weapon_Name, int ammo)
    {
        ...
        if (Main.weapon_list[weapon_id].classe == "Primary")
        {
            ...
            if ((long)Client.GetData<dynamic>("primary_weapon") != (long)hashcode)
            {
                ...
                {
                    API.Shared.ConsoleOutput("[HATA]: Bu silahı çıkartmak imkansız. " + Client.GetData<dynamic>("primary_weapon") + "");
                }
        ...
        else if (Main.weapon_list[weapon_id].classe == "Secundary")
        {
            ...
            if ((long)Client.GetData<dynamic>("secundary_weapon") != (long)hashcode)
            {
                ...
                {
                    API.Shared.ConsoleOutput("[HATA]: Bu silahı çıkartmak imkansız. " + Client.GetData<dynamic>("secundary_weapon") + "");
                }
        ...
        else if (Main.weapon_list[weapon_id].classe == "Melee")
        {
            ...
            if ((long)Client.GetData<dynamic>("weapon_meele") != (long)hashcode)
            {
                ...
                {
                    API.Shared.ConsoleOutput("[HATA]: Bu silahı çıkartmak imkansız. " + Client.GetData<dynamic>("weapon_meele") + "");
                }
        ...
        else if (Main.weapon_list[weapon_id].classe == "pistol")
        {
            ...
            if (Client.GetData<dynamic>("pistol_weapon") == 0)  // First login fix ;
            {
                ...
                NAPI.Player.GivePlayerWeapon(Client, Client.GetData<dynamic>("pistol_weapon"), Client.GetData<int>("pistol_ammunation"));
                NAPI.Player.SetPlayerCurrentWeapon(Client, Client.GetData<dynamic>("pistol_weapon"));
                NAPI.Player.SetPlayerWeaponAmmo(Client, Client.GetData<dynamic>("pistol_weapon"), Client.GetData<int>("pistol_ammunation"));
                return;
            }
            ...
            if ((long)Client.GetData<dynamic>("pistol_weapon") != (long)hashcode)
            {
                ...
                {
                    API.Shared.ConsoleOutput("[HATA]: Bu silahı çıkartmak imkansız. " + Client.GetData<dynamic>("pistol_weapon") + "");
                }
        ...
        else if (Main.weapon_list[weapon_id].classe == "Tazer")
        {
            ...
            if ((long)Client.GetData<dynamic>("tazer_weapon") != (long)hashcode)
            {
                ...
                {
                    API.Shared.ConsoleOutput("[HATA]: Bu silahı çıkartmak imkansız. " + Client.GetData<dynamic>("tazer_weapon") + "");
                }
    ...
    /* [ServerEvent(Event.PlayerWeaponSwitch)]
     public void OnPlayerWeaponSwitch(Player Client, WeaponHash oldWeapon, WeaponHash newWeapon)
     {
         ...
         if (weapon_id == -1)
         {
             Main.DisplayErrorMessage(Client,error,NotifyPosition.BottomCenter, "Não foi possível encontrar esta arma em nosso banco de dados.");
             return;
         }
    ...
    public void playerTakeoffWeapon(Player Client, Int64 weaponHash, int ammo)
    {
        ...
        if (weapon_id == -1)
        {
            Main.DisplayErrorMessage(Client, "error", "Bu silah mevcut değil.");
            return;
        }
        ...
        if (Main.weapon_list[weapon_id].classe == "Primary")
        {
           /* if (ammo > (Client.GetData<dynamic>("primary_ammunation") - 1))
            {
                AntiCheat.AntiAmmoCheat(Client, ammo, Client.GetData<dynamic>("secundary_ammunation"));
                return;
            }*/
        ...
        else if (Main.weapon_list[weapon_id].classe == "Secundary")
        {
          ...
          /*  if (ammo > (Client.GetData<dynamic>("secundary_ammunation") - 1))
            {
                AntiCheat.AntiAmmoCheat(Client, ammo, Client.GetData<dynamic>("secundary_ammunation"));
                return;
            }*/
        ...
        else if (Main.weapon_list[weapon_id].classe == "pistol")
        {
           ...
           /* if (ammo > (Client.GetData<int>("pistol_ammunation") - 1))
            {
                AntiCheat.AntiAmmoCheat(Client, ammo, Client.GetData<dynamic>("pistol_ammunation"));
                return;
            }*/

            if ((Client.GetData<int>("pistol_ammunation") - 1) == 0)
            { 
                Client.SetData<int>("pistol_ammunation", 0);
                Client.SetWeaponAmmo(Client.CurrentWeapon, 0); 
                Client.GiveWeapon(WeaponHash.Unarmed, 1); 
                return; 
            }

            Client.SetData<int>("pistol_ammunation", Client.GetData<int>("pistol_ammunation") - 1);
        }
    ...
    {
        Main.CreateMySqlCommand("UPDATE characters SET `pistol_weapon` = '" + Client.GetData<dynamic>("pistol_weapon") + "', `pistol_ammunation` = '" + Client.GetData<int>("pistol_ammunation") + "',`primary_weapon` = '" + Client.GetData<dynamic>("primary_weapon") + "', `primary_ammunation` = '" + Client.GetData<dynamic>("primary_ammunation") + "', `secundary_weapon` = '" + Client.GetData<dynamic>("secundary_weapon") + "', `secundary_ammunation` = '" + Client.GetData<dynamic>("secundary_ammunation") + "',  `melee` = '" + Client.GetData<dynamic>("weapon_meele") + "' ,  `tazer_weapon` = '" + Client.GetData<dynamic>("tazer_weapon") + "' WHERE `id` = '" + AccountManage.GetPlayerSQLID(Client) + "';");
    }
    ...
    public static void LoadPlayerWeaponIC(Player Client)
    {
        ...
        if (Client.GetData<dynamic>("pistol_weapon") != 0)
        {
            ...
            Client.GiveWeapon((WeaponHash)Client.GetData<dynamic>("pistol_weapon"), (int)Client.GetData<int>("pistol_ammunation"));
        }
