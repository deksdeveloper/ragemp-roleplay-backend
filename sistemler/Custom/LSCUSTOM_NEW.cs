...
public class LSCUSTOM_NEW : Script
{
    ...
    public LSCUSTOM_NEW()
    {
        ...
        {
            ls.label_position = API.Shared.CreateTextLabel(Translation.ls_custom_label_free, ls.position, 10.0f, 8.2f, 4, new Color(0, 122, 255, 150), false, 0);
        }
        ...
        foreach (var ls in ls_custom)
        {
            if (Main.IsInRangeOfPoint(Client.Position, ls.position, 3.0f) && ls.in_use == false && Client.IsInVehicle && Client.VehicleSeat == (int)VehicleSeat.Driver)
            {
                ...
                if (Client.Vehicle.GetData<dynamic>("Mashin_Owner") != AccountManage.GetPlayerSQLID(Client))
                {
                    ...
                    Main.DisplayErrorMessage(Client, "error", "Niste vlasnik vozila!");
    ...
    public static void SelectMenuResponse(Player Client, String callback, int id)
    {
        ...
        else if (callback == "LSCUSTOM_RearBumper")
        {
            ...
            {
                Main.DisplayErrorMessage(Client, "error", "Bu bileşen zaten sizde mevcut.");
            ...
            {
                Main.DisplayErrorMessage(Client, "error", "Banka hesabınızda yeterli paranız yok.");
                ResetVehiclePerviewCustomize(Client, Client.Vehicle.GetData<int>("index_Mashin"));
                return;
            }
            ...
            Main.DisplayErrorMessage(Client, "success", "Arka tampon satın alındı!");
        ...
        else if (callback == "LSCUSTOM_Protection")
        {
            ...
            Main.DisplayErrorMessage(Client, "success", "Araç zırhlandı!");
            Main.PlaySoundFrontend(Client, "Drill_Pin_Break", "DLC_HEIST_FLEECA_SOUNDSET");
        }
        else if (callback == "LSCUSTOM_FrontBumper")
        {
            ...
            PlayerVehicle.SavePlayerVehicle(Client, Client.Vehicle.GetData<int>("index_Mashin"));
            Main.DisplayErrorMessage(Client, "success", "Ön tampon satın alındı!");
            Main.PlaySoundFrontend(Client, "Drill_Pin_Break", "DLC_HEIST_FLEECA_SOUNDSET");
        }
        else if (callback == "LSCUSTOM_Plate")
        {
            ...
            PlayerVehicle.SavePlayerVehicle(Client, Client.Vehicle.GetData<int>("index_Mashin"));
            Main.DisplayErrorMessage(Client, "success", "Plaka satın alındı.");
            Main.PlaySoundFrontend(Client, "Drill_Pin_Break", "DLC_HEIST_FLEECA_SOUNDSET");
        }
        else if (callback == "LSCUSTOM_Breake")
        {
            ...
            PlayerVehicle.SavePlayerVehicle(Client, Client.Vehicle.GetData<int>("index_Mashin"));
            Main.DisplayErrorMessage(Client, "success", "Fren satın alındı!");
            Main.PlaySoundFrontend(Client, "Drill_Pin_Break", "DLC_HEIST_FLEECA_SOUNDSET");
        }
        else if (callback == "LSCUSTOM_engine")
        {
            ...
            {
                Main.DisplayErrorMessage(Client, "error", "Bu bileşene zaten sahipsiniz.");
                ResetVehiclePerviewCustomize(Client, Client.Vehicle.GetData<int>("index_Mashin"));
                return;
            }
            if (Main.GetPlayerBank(Client) <= Engine[id + 1].price)
            {
                Main.DisplayErrorMessage(Client, "error", "Bankada yeterli paranız yok.");
                ResetVehiclePerviewCustomize(Client, Client.Vehicle.GetData<int>("index_Mashin"));
                return;
            }
            ...
            PlayerVehicle.SavePlayerVehicle(Client, Client.Vehicle.GetData<int>("index_Mashin"));
            Main.DisplayErrorMessage(Client, "success", "Motor geliştirildi!");
            Main.PlaySoundFrontend(Client, "Drill_Pin_Break", "DLC_HEIST_FLEECA_SOUNDSET");
        }
        else if (callback == "LSCUSTOM_hood")
        {
            ...
            PlayerVehicle.SavePlayerVehicle(Client, Client.Vehicle.GetData<int>("index_Mashin"));
            Main.DisplayErrorMessage(Client, "success", "Kaput alındı!");
            Main.PlaySoundFrontend(Client, "Drill_Pin_Break", "DLC_HEIST_FLEECA_SOUNDSET");
        }
        else if (callback == "LSCUSTOM_horn")
        {
            ...
            PlayerVehicle.SavePlayerVehicle(Client, Client.Vehicle.GetData<int>("index_Mashin"));
            Main.DisplayErrorMessage(Client, "success", "Korna alındı!");
            Main.PlaySoundFrontend(Client, "Drill_Pin_Break", "DLC_HEIST_FLEECA_SOUNDSET");
        }
        else if (callback == "LSCUSTOM_headlight")
        {
            ...
            PlayerVehicle.SavePlayerVehicle(Client, Client.Vehicle.GetData<int>("index_Mashin"));
            Main.DisplayErrorMessage(Client, "success", "Far satın alındı!");
            Main.PlaySoundFrontend(Client, "Drill_Pin_Break", "DLC_HEIST_FLEECA_SOUNDSET");
        }
        else if (callback == "LSCUSTOM_exhaust")
        {
            ...
            PlayerVehicle.SavePlayerVehicle(Client, Client.Vehicle.GetData<int>("index_Mashin"));
            Main.DisplayErrorMessage(Client, "success", "Egzoz alındı!");
            Main.PlaySoundFrontend(Client, "Drill_Pin_Break", "DLC_HEIST_FLEECA_SOUNDSET");
        }
        else if (callback == "LSCUSTOM_glass")
        {
            ...
            PlayerVehicle.SavePlayerVehicle(Client, Client.Vehicle.GetData<int>("index_Mashin"));
            Main.DisplayErrorMessage(Client, "success", "Pencereler karartıldı!");
            Main.PlaySoundFrontend(Client, "Drill_Pin_Break", "DLC_HEIST_FLEECA_SOUNDSET");
        }
        else if (callback == "LSCUSTOM_frame")
        {
            ...
            PlayerVehicle.SavePlayerVehicle(Client, Client.Vehicle.GetData<int>("index_Mashin"));
            Main.DisplayErrorMessage(Client, "success", "Çerçeve alındı!");
            Main.PlaySoundFrontend(Client, "Drill_Pin_Break", "DLC_HEIST_FLEECA_SOUNDSET");
        }
