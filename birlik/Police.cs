...
class Police : Script
{
    ...
    public static void DisplayCopUniforms(Player Client)
    {
        ...
        menu_item_list.Add(new { Type = 1, Name = "Standart - uzun kollu", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Standart - kısa kollu", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Trafik - uzun kollu", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Trafik - kısa kollu", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Özel - kısa kollu", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Özel - uzun kollu", Description = "", RightLabel = "" });

        // menu_item_list.Add(new { Type = 1, Name = "Resmi Kıyafet", Description = "", RightLabel = "" });

        InteractMenu.CreateMenu(Client, "POLICE_UNIFORM_RESPONSE", "Üniforma", "~b~Seç:", true, NAPI.Util.ToJson(menu_item_list), false);
    }
    ...
    public static void DisplayCopAddons(Player Client)
    {
        ...
        menu_item_list.Add(new { Type = 1, Name = "Zırh - Polis", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Zırh - Müdahale", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Telsiz", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Parlak Ceket", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Kılıf", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Şapka", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Bere", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Kask", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Rozet 1", Description = "", RightLabel = "" });
        menu_item_list.Add(new { Type = 1, Name = "Rozet 2", Description = "", RightLabel = "" });

        //  menu_item_list.Add(new { Type = 1, Name = "Kolah Rasmi ", Description = "", RightLabel = "" });

        InteractMenu.CreateMenu(Client, "POLICE_ADDON_RESPONSE", "Eklentiler", "~b~Seç:", true, NAPI.Util.ToJson(menu_item_list), false);
    ...
    public static void SetPlayerCrime(Player Client, int level)
    {
        ...
        Main.DisplayErrorMessage(Client, "info", level + " aranma seviyesine ulaştınız!"); // emin değilim
...

        {
            ...
            {
                Main.SendMessageWithTagToPlayer(target, "" + Main.EMBED_BLUE + "Dispatch - ", "" + Main.EMBED_COP_Message + ". Konuşan: " + AccountManage.GetCharacterName(Client) + Main.EMBED_COP_Message + " Aranma seviyesi: ~y~" + Client.GetSharedData<dynamic>("character_wanted_level") + ".");
            }
        }
    }
    ...
    public static void wantedlevelminus(Player Client, int level)
    {
        ...
        Main.CreateMySqlCommand("UPDATE `characters` SET `wanted` = '" + wlevel + "'  WHERE `userid` = '" + Client.GetData<dynamic>("player_sqlid") + "';");
        Client.SetSharedData("character_wanted_level", wlevel);
        Main.DisplayErrorMessage(Client, "info", "Aranma seviyeniz " + level + " seviyesine düşürüldü!");
    }
    ...
    public static void SelectMenuResponse(Player Client, String callbackId, int selectedIndex, String objectName, String valueList)
    {
        if (callbackId == "CRIME_LIST_RESPONSE")
        {
            ...
            for (int i = 0; 0 < Main.crime_list.Count; i++)
            {
                if (i == crime_id)
                {
                    ...
                    NAPI.Notification.SendNotificationToPlayer(Client, "Yeni aranma eklediniz: " + AccountManage.GetCharacterName(target) + "");
                    return;
                }
            }
        }
        ...
        else if (callbackId == "POLICE_VEHICLE_SLOT_SPAWN")
        {
            ...
            if (factionid != 1) { InteractMenu_New.SendNotificationError(Client, "Çalışan değilsiniz!"); return; }
        ...
        if (index == -1)
            {
                Main.SendErrorMessage(Client, "Garajda  yer yok!");
                return;
            }
    ...
    public static void DragPlayerToTarget(Player Client, Player target)
    {
        ...
        {
            NAPI.Notification.SendNotificationToPlayer(Client, "Birisi zaten o oyuncuyu sürüklüyor!");
            return;
        }
        ...
        {
            NAPI.Notification.SendNotificationToPlayer(target, "~r~Hata:~w~ Önce kişiyi kelepçelemeniz gerekiyor!");
            return;
        }
    next:
        ...
        {
            alvo.TriggerEvent("Send_ToChat", "", "<font color ='#C2A2DA'>* " + UsefullyRP.GetPlayerNameToTarget(target, alvo) + " " + UsefullyRP.GetPlayerNameToTarget(Client, alvo) + " kişisini sürüklüyor.");
        }
    }
    ...
    public static void UnDragPlayer(Player Client)
    {
        ...
        foreach (Player alvo in proxPlayers)
        {
            alvo.TriggerEvent("Send_ToChat", "", "<font color ='#C2A2DA'>* " + UsefullyRP.GetPlayerNameToTarget(Client, alvo) + " boş " + UsefullyRP.GetPlayerNameToTarget(Client, alvo) + ".");
        }
    ...
    public static void FriskPlayerToTarget(Player target, Player Client)
    {
        ...
        {
            Main.SendCustomChatMessasge(Client, "Birincil silah ~c~" + target.GetData<dynamic>("primary_weapon"));
        }
        if (target.GetData<dynamic>("pistol_weapon") != 0)
        {
            Main.SendCustomChatMessasge(Client, "Tabanca ~c~" + target.GetData<dynamic>("pistol_weapon"));
        }
        if (target.GetData<dynamic>("secundary_weapon") != 0)
        {
            Main.SendCustomChatMessasge(Client, "İkincil silah ~c~" + target.GetData<dynamic>("secundary_weapon"));
        }
        if (target.GetData<dynamic>("weapon_meele") != 0)
        {
            Main.SendCustomChatMessasge(Client, "Yakın dövüş ~c~" + target.GetData<dynamic>("weapon_meele"));
        }
        ...
        for (int index = 0; index < Inventory.MAX_INVENTORY_ITENS; index++)
        {
            if (target.GetData<dynamic>("inventory_item_" + index + "_type") != 0 && target.GetData<dynamic>("inventory_item_" + index + "_type") < Inventory.itens_available.Count)
            {
                ...
                {
                    Main.SendCustomChatMessasge(Client, "(Eşyalar) ~c~" + Inventory.itens_available[target.GetData<dynamic>("inventory_item_" + index + "_type")].name + " ~w~(" + target.GetData<dynamic>("inventory_item_" + index + "_amount") + ") ");
                }
            }
        }
        Main.SendCustomChatMessasge(Client, "~w~-----------------------------");
    ...
    public void SetBadge(Player player, string nameorid, int Badge_Id)
    {
        if (AccountManage.GetPlayerGroup(player) == 1)
        {
            if (AccountManage.GetPlayerLeader(player) == 1 || AccountManage.GetPlayerRank(player) >= 8)
            {
                ...
                if (!target.Exists)
                {
                    Main.DisplayErrorMessage(player, "error", "Bu oyuncu oyunda değil!");
                    return;
                }
    ...
    public static string GetBadgeNameWithBadgeID(Player player, int badge_number)
    {
        ...
        switch (badge_number)
        {
            ...
            case int n when (n >= 2 && n <= 4):
                badgename = "Şef Yardımcısı";
                break;
            case int n when (n >= 5 && n <= 9): // ayar cekılcek amk rütbelerine
                badgename = "Komutan";
                break;
            ...
            case int n when (n >= 160 && n <= 171):
                badgename = "Kıdemli Polis";
                break;
            case int n when (n >= 130 && n <= 159):
                badgename = "Bağımsız Polis";
                break;
            case int n when (n >= 101 && n <= 129):
                badgename = "Polis Adayı";
                break;
            case int n when (n >= 210 && n <= 233):
                badgename = "Öğrenci";
                break;
            default:
                badgename = "Bilinmiyor";
                break;
        }
        return badgename;
    }
    ...
    public async Task CMD_finevehicle(Player Client, string placa)
    {
        Task.Run(() =>
        {
            ...
            if (placa.Length <= 3)
            {
                Main.DisplayErrorMessage(Client, "info", " Neophodno je da unesete minimum 3 karaktera!");
                return;
            }
    ...
    public void mdcPersonAddFine(Player player, string name, string description, int price)
    {
        Task.Run(() =>
        {
            if (price >= 60000)
            {
                Main.DisplayErrorMessage(player, "info", "Ne mozete napisati kaznu koja je veca od: $60.000");
                return;
            }
            using (MySqlConnection Mainpipeline = new MySqlConnection(Main.myConnectionString))
            {
            ...
            if (name != null)
            {
                if (Main.IsInRangeOfPoint(player.Position, name.Position, 5))
                {
                    ...
                    if (dozvola == "auto")
                    {
                        ...
                        Main.DisplayErrorMessage(player, "success", "Oduzeli ste dozvolu.");
                        Main.DisplayErrorMessage(name, "info", "Oduzeta vam je vozacka dozvola od strane policajca" + AccountManage.GetCharacterName(player) + "");
                    }
                    else if (dozvola == "moto")
                    {
                        ...
                        Main.SavePlayerInformation(name);
                        Main.DisplayErrorMessage(player, "success", "Oduzeli ste dozvolu.");
                        Main.DisplayErrorMessage(name, "info", "Oduzeta vam je moto dozvola od strane policajca" + AccountManage.GetCharacterName(player) + "");
                    }
                    else if (dozvola == "letenje")
                    {
                        ...
                        Main.SavePlayerInformation(name);
                        Main.DisplayErrorMessage(player, "success", "Oduzeli ste dozvolu.");
                        Main.DisplayErrorMessage(name, "info", "Oduzeta vam je dozvola za letenje od strane policajca" + AccountManage.GetCharacterName(player) + "");
                    }
                    else if (dozvola == "pecanje")
                    {
                        ...
                        Main.SavePlayerInformation(name);
                        Main.DisplayErrorMessage(player, "success", "Oduzeli ste dozvolu.");
                        Main.DisplayErrorMessage(name, "info", "Oduzeta vam je dozvola za pecanje od strane policajca" + AccountManage.GetCharacterName(player) + "");
                    }
                    else if (dozvola == "gun")
                    {
                        ...
                        Main.SavePlayerInformation(name);
                        Main.DisplayErrorMessage(player, "success", "Oduzeli ste dozvolu.");
                        Main.DisplayErrorMessage(name, "info", "Oduzeta vam je dozvola za oruzije od strane policajca" + AccountManage.GetCharacterName(player) + "");
                    }
                }
            }
        }
    ...
    public void TryPayFine(Player player, int id, int price)
    {
            try
            {
                ...
                if (canpay == false)
                {
                    Main.DisplayErrorMessage(player, "info", "Gradjanin nema dovoljno novca!");
                    return;
                }
                if (Main.GetPlayerBank(player) < price)
                {
                    Main.DisplayErrorMessage(player, "error", " $" + price + " kayna nije placena!!");
                    return;
                }
                ...
                Main.DisplayErrorMessage(player, "success", " $" + price + " kazna je placena!");
    ...
    public static void delpolcar(Player player)
    {
        ...
        {
            Main.DisplayErrorMessage(player, "error", "Bu LSPD bünyesinde bir araç değil!");
            return;
        }
    }
    ...
    public static void lspdguns(Player Client, int index)
    {
        try
        {
            ...
            switch (index)
            {
                case 0:
                    {
                        Main.DisplayErrorMessage(Client, "success", "El feneri aldınız.");
                ...
                case 1:
                    {
                        Main.DisplayErrorMessage(Client, "success", "Jop aldınız.");
                        NAPI.Player.GivePlayerWeapon(Client, WeaponHash.Nightstick, 0);
                        break;
                    }
                case 2:
                    {
                        Main.DisplayErrorMessage(Client, "success", "Taser aldınız.");
                        NAPI.Player.GivePlayerWeapon(Client, WeaponHash.Stungun, 0);
                        break;
                    }
                case 3:
                    {
                        Main.DisplayErrorMessage(Client, "success", "Pistol aldınız.");
                ...
                case 4:
                    {
                        ...
                        {
                            Main.DisplayErrorMessage(Client, "info", "Rütbeniz 4 veya üstü değil.");
                            return;
                        }
                        Main.DisplayErrorMessage(Client, "success", "Shotgun aldınız.");
                ...
                case 5:
                    {
                        ...
                        {
                            Main.DisplayErrorMessage(Client, "info", "Rütbeniz 5 veya üstü değil.");
                            return;
                        }

                        Main.DisplayErrorMessage(Client, "success", "Pump Shotgun MK2 aldınız.");
                ...
                case 6:
                    {
                        ...
                        {
                            Main.DisplayErrorMessage(Client, "info", "Rütbeniz 2 veya üstü değil.");
                            return;
                        }
                        Main.DisplayErrorMessage(Client, "success", "SMG aldınız.");
                ...
                case 7:
                    {
                        ...
                        {
                            Main.DisplayErrorMessage(Client, "info", "Rütbeniz 3 veya üstü değil.");
                            return;
                        }

                        Main.DisplayErrorMessage(Client, "success", "PDW aldınız.");
                ...
                case 8:
                    {
                        ...
                        Main.DisplayErrorMessage(Client, "success", "Assault rifle aldınız.");
                ...
                case 9:
                    {
                        ...
                        Main.DisplayErrorMessage(Client, "success", "Special carbine aldınız.");
                ...
                case 10:
                    {
                        ...
                        {
                            Main.DisplayErrorMessage(Client, "info", "Rütbeniz 7 veya üstü değil.");
                            return;
                        }
                        Main.DisplayErrorMessage(Client, "success", "Sniper tüfeği aldınız.");
                        NAPI.Player.GivePlayerWeapon(Client, WeaponHash.Heavysniper, 60);
                        break;
                    }
                case 11:
                    {
                        Main.DisplayErrorMessage(Client, "success", "Radyo aldınız.");
                        Inventory.GiveItemToInventory(Client, 23, 1);
                        break;
                    }
                case 12:
                    {
                        Main.DisplayErrorMessage(Client, "success", "Zırh aldınız.");
                        Client.Armor = 100;
                        break;
                    }
                case 13:
                    {
                        Main.DisplayErrorMessage(Client, "success", "İlk yardım kiti aldınız.");
                        Client.Health = 100;
                        break;
                    }
                ...
                case 14:
                    {
                        Main.DisplayErrorMessage(Client, "success", "Advanced Rifle aldınız.");
                ...
                case 0:
                    {
                        ...
                        var vehicle = NAPI.Vehicle.CreateVehicle(vgolf, new Vector3(442.40292, -1015.0793, 28.644115), 90.14f, 0, 0);
                        vehicle.Dimension = 0;
                        ...
                        Main.DisplayErrorMessage(Client, "success", "Bir araç çıkarttınız.");
                        break;
                    }
                case 1:
                    {
