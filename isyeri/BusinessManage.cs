...
public class BusinessManage : Script
{
            ...
            using (var Mainpipeline = new MySqlConnection(Main.myConnectionString))
            {
                ...
                using (MySqlDataReader reader = query.ExecuteReader())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        business_list[index].Chemical_marker = NAPI.Marker.CreateMarker(1, new Vector3(float.Parse(X[0]), float.Parse(X[1]), float.Parse(X[2]) - 1.0), new Vector3(), new Vector3(), 0.8f, new Color(0, 122, 255, 150));
                        business_list[index].Chemical_label = NAPI.TextLabel.CreateTextLabel(Main.LabelColor + "Kimya Dükkanı~n~" + Main.LabelCommandColor + "« Y »", new Vector3(float.Parse(X[0]), float.Parse(X[1]), float.Parse(X[2]) + 0.3), 11, 0.600f, 0, new Color(0, 122, 255, 150));
                        ...
                        business_list[index].business_object_MarkerID = NAPI.Marker.CreateMarker(1, new Vector3(float.Parse(business_list[index].business_posX), float.Parse(business_list[index].business_posY), float.Parse(business_list[index].business_posZ) - 4.0), new Vector3(), new Vector3(), 0.8f, new Color(0, 122, 255, 150));
                        //business_list[index].business_object_TextLabel = NAPI.TextLabel.CreateTextLabel("Undefined", new Vector3(float.Parse(business_list[index].business_posX), float.Parse(business_list[index].business_posY), float.Parse(business_list[index].business_posZ) + 0.65), 8, 0.400f, 4, new Color(0, 122, 255, 150));
                        business_list[index].business_second_label = NAPI.TextLabel.CreateTextLabel("", new Vector3(float.Parse(business_list[index].business_posX), float.Parse(business_list[index].business_posY), float.Parse(business_list[index].business_posZ) - 0.09), 3, 0.380f, 4, new Color(0, 122, 255, 150));
                        ...
                        business_list[index].business_store_buy_label = NAPI.TextLabel.CreateTextLabel("~g~" + business_list[index].business_Name + "~w~  ~n~~w~[~g~ Y~w~ ]", new Vector3(business_list[index].business_store_buy_x, business_list[index].business_store_buy_y, business_list[index].business_store_buy_z + 0.5), 16, 0.800f, 0, new Color(0, 122, 255, 150));
                        ...
                        business_list[index].business_clothes_shirt_marker = NAPI.Marker.CreateMarker(25, business_list[index].business_clothes_shirt - new Vector3(0, 0, 0.8), new Vector3(), new Vector3(), 0.8f, new Color(0, 122, 255, 150));
                        business_list[index].business_clothes_shirt_label = NAPI.TextLabel.CreateTextLabel("~g~" + business_list[index].business_Name + "~y~~w~ ~y~~w~~n~~w~[~g~ Y~w~ ]", business_list[index].business_clothes_shirt + new Vector3(0, 0, 0.3), 11, 1.0f, 0, new Color(0, 122, 255, 150));
                        ...
                        business_list[index].business_barber_marker = NAPI.Marker.CreateMarker(25, business_list[index].business_barber - new Vector3(0, 0, 0.8), new Vector3(), new Vector3(), 0.8f, new Color(0, 122, 255, 150));
                        business_list[index].business_barber_label = NAPI.TextLabel.CreateTextLabel("~g~" + business_list[index].business_Name + "~y~~w~ ~y~~w~~n~~w~[~g~ Y~w~ ]", business_list[index].business_barber + new Vector3(0, 0, 0.3), 11, 1.0f, 0, new Color(0, 122, 255, 150));
        ...
        using (MySqlConnection Mainpipeline = new MySqlConnection(Main.myConnectionString))
        {
            ...
            using (MySqlDataReader reader = query.ExecuteReader())
            {
                while (reader.Read())
                {
                    ...
                    business_list[index].business_dealership_buy_label = NAPI.TextLabel.CreateTextLabel("~g~~h~[ " + business_list[index].business_Name + " ]~h~~w~~n~~c~[~y~ Y~c~ ]", business_list[index].business_dealership_buy + new Vector3(0, 0, 0.3), 16, 0.600f, 0, new Color(0, 122, 255, 150));
                    business_list[index].business_dealership_buy_marker = NAPI.Marker.CreateMarker(1, business_list[index].business_dealership_buy - new Vector3(0, 0, 1.0), new Vector3(), new Vector3(), 0.8f, new Color(0, 122, 255, 150));
                }
            }
            Mainpipeline.Close();
        }
    ...
    {
        if (business_list[business_id].business_Type == 2)
        {
            NAPI.Blip.SetBlipName(business_list[business_id].business_objects_blip, "24/7 Mağazası");
        ...
        {
            NAPI.Blip.SetBlipName(business_list[business_id].business_objects_blip, "Helikopter Salonu");
        ...
        {
            NAPI.Blip.SetBlipName(business_list[business_id].business_objects_blip, "Kamyon Salonu");
        ...
        {
            NAPI.Blip.SetBlipName(business_list[business_id].business_objects_blip, "Kuaför Salonu");
        ...
        {
            NAPI.Blip.SetBlipName(business_list[business_id].business_objects_blip, "Araç Gereç Mağazası");
        ...
        {
            NAPI.Blip.SetBlipName(business_list[business_id].business_objects_blip, "Dövme Salonu");
    ...
    public static string Business_Type(int business_type)
    {
        ...
        switch (business_type)
        {
            ...
            case 4:
                {
                    type = "Otomobil Bayisi";
                    break;
                }
            case 5:
                {
                    type = "Benzin İstasyonu";
                    break;
                }
            case 6:
                {
                    type = "Motosiklet Bayisi";
                    break;
                }
            case 7:
                {
